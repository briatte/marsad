...
The ideal points are estimated [as follows](https://github.com/briatte/marsad/blob/master/code/vote.r#L212-L213):
...
In the two-dimensional [alpha-NOMINATE](http://cran.r-project.org/web/packages/anominate/) model, all but 2 Nahdha members (_n_ = 87) score above 0 on the first dimension, and all but 12/13 non-Nahdha members (_n_ = 130) score below 0 on that same dimension:
...
Similarly, a two-dimensional [optimal classification][oc] assigns 81–83 out of 87 Nahdha members and 4/5 out of 130 non-Nahdha members to the same (top-right) quadrant:

![](plots/oc_2d.jpg)

[oc]: http://cran.r-project.org/web/packages/oc/

> One or two members are very close to zero and will flip from one model to another.

## TODO

- [x] add birth year values
